...
Inform your users incase if the device is offline and can't reach your backend servers. Listening to network status helps in blocking the user if they want to access any  network dependent features.
